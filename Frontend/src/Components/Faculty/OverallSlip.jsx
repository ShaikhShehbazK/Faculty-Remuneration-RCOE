...
function OverallSlip() {
  ...
  const handleBack = () => navigate("/faculty/payments", { replace: true });
        ...
        <Col md={9}>
                ...
                <Card.Body className="p-4">
                  <div className="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <h4 className="fw-bold mb-0">
                        {paymentDetails.subjects.length}
                      </h4>
                    </div>
                  </div>
                </Card.Body>
          ...
          <Card className="mb-4 p-4 shadow rounded-4 border-0 bg-white">
            ...
            <small className="text-muted mb-3 d-block">
              Complete details of the payment transaction and faculty
              information.
            </small>
          ...
          <Card className="mb-4 p-4 shadow rounded-4 border-0 bg-white">
            ...
            <small className="text-muted mb-3 d-block">
              Detailed breakdown of all subjects and their remuneration
              components.
            </small>
              ...
              <tbody>
                {paymentDetails.subjects.map((subject, idx) => (
                  <tr key={idx}>
                    ...
                    <td>
                      {subject.termWork.quantity}{" "}
                      <span className="badge bg-secondary ms-1">
                        ₹{subject.termWork.rate}
                      </span>
                    </td>
                    <td>
                      {subject.oral.quantity}{" "}
                      <span className="badge bg-secondary ms-1">
                        ₹{subject.oral.rate}
                      </span>
                    </td>
                    <td>
                      {subject.semester.quantity}{" "}
                      <span className="badge bg-secondary ms-1">
                        ₹{subject.semester.rate}
                      </span>
                    </td>
                    <td>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="fw-bold text-primary">
                    ₹{paymentDetails.summary.travel.toLocaleString()}
                  </td>
                </tr>
                <tr>
                  <td>Base Salary</td>
                  <td className="fw-bold text-primary">
                    ₹{paymentDetails.summary.base.toLocaleString()}
                  </td>
                </tr>
                <tr>
                  <td>Calculated Remuneration</td>
                  <td className="fw-bold text-success">
                    ₹{paymentDetails.summary.calculated.toLocaleString()}
                  </td>
                </tr>
